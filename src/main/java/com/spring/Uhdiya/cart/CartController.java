...
public class CartController {
   ...
   public String selectDel( 
         ...
         @RequestParam("member_id")  String member_id ,HttpServletRequest request, HttpServletResponse response){
      int result = 0;
      String res="";
...
//      }
   ...
   public String addCart(
         ...
         @RequestParam("member_id") String member_id,
         @RequestParam("product_code") String product_code,
         @RequestParam("cart_qty") int cart_qty ,HttpServletRequest request, HttpServletResponse response)   {
      System.out.println(member_id);
