				...
				<c:if test="${not empty qna_list}">
					<c:forEach var="qna" items="${qna_list}" varStatus="num">
						<tr>
							...
							<td class="qna_product_title" style="text-align: left;">
								<a href="${path}/board/qna_page?qna_id=${qna.qna_id}&qna_writeId=${qna.qna_writeId}">
								<i class="fa-solid fa-lock"></i>&nbsp;&nbsp;${qna.qna_title}</a>
							</td>
