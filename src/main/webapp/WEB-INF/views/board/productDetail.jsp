...
<div class="productDetailPage">
	...
	<div class="contentsIntro">
		<div class="contentsIntro_detailImg">	<!-- 상품이미지 -->
			 <img class="detailImg" src="/Uhdiya/resources/img/product/beans001.jpg"> 
		</div>
	...
	<div class="contentsMain">
		...
		<div class="contentsMain_contents">	
			<p id="info"></p> <!-- 클릭이동한곳 -->
			<img src="/Uhdiya/resources/img/product/beans001_info.jpg">
		</div>
		...
		<div class="contentsMain_board_qna" align="center"> 
			...
			<jsp:include page="/WEB-INF/views/board/qna_product.jsp">
				<jsp:param value="${qnaMap}" name="qnaMap"/>
			</jsp:include>
		</div>
	</div>
