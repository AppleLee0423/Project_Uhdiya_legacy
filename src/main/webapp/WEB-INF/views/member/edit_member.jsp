...
<head>
   ...
   <script>
      ...
      $(function(){
         ...
         $("select[name='member_phone']").val(콜).prop("selected",true);
      });
...
<body>
   <div class="div" style="margin-top: 75px; min-height: 200px;"
      ...
      <form id="frm" method="post" action="${path }/member/edit">
         ...
         <table width="700" height="550" cellpadding="0"
            ...
            <tr class="register" height="30">
               ...
               <td>
                  ...
                  <button id="PcheckCss"><a href="javascript:void(0);" onclick="checkPw()">확인</a></button>
               </td>
            </tr>
            <tr height="7">
               <td colspan="3"><hr /></td>
            ...
            <tr>
               ...
               <td>
                  ...
                  <input type="button" onclick="execution_daum_address()" value="우편번호 찾기" style="background-color: white; border-width: thin; border-radius: 10%;">
                  <br/>
...
<!--          <button class="w-100 btn btn-lg btn-primary"
            ...
            onclick="editMember()" style="background-color: #C26225; color: white; padding:10px 20px; border-radius: 20px; border:none; font-size:20px;">&nbsp;&nbsp;&nbsp;
            <input class="back" type="button" value="돌아가기"
            onclick="history.back();"style="background-color: #C26225; color: white; padding:10px 20px; border-radius: 20px; border:none; font-size:20px;"/>&nbsp;&nbsp;&nbsp;
            <input class="back" type="button" value="회원탈퇴" style="background-color: #C26225; color: white; padding:10px 20px; border-radius: 20px; border:none; font-size:20px;"
